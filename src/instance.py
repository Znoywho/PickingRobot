...
def Paper_Example() -> NewInstance:
    # Io1 = {i4 , i5 }, Io2 = {i1, i2 , i4 }, Io3 = {i1, i2, i5 }, Io 4 = {i2 , i3 }, Io5 = {i1 }, Io6 = {i1 }, Io7 = {i2},
    # Io8 = {i1 , i2 , i3 }, and racks R = {r1 , r2 , r3 } with Ir1 = {i2, i3 }, Ir2 = {i1 , i4 }, and Ir3 = {i5 }.
    ...
    return NewInstance(orders=orders, racks=racks, all_items=all_items, capacity=B)
